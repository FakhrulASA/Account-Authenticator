...
public class AccountHelper {
     ...
     * Account type id
     */
    public static final String ACCOUNT_TYPE = "com.fakhrulasa.accountmanagement";
     ...
     * Auth Token
     */
    public static final String AUTH_TOKEN = "fakhrulasa_auth_token";

    /**
     * Auth token types
     */
    public static final String AUTHTOKEN_TYPE_READ_ONLY = "Read only";
    public static final String AUTHTOKEN_TYPE_READ_ONLY_LABEL = "Read only access to a com.fakhrulasa.accountathenticator account";

    public static final String AUTHTOKEN_TYPE_FULL_ACCESS = "Full access";
    public static final String AUTHTOKEN_TYPE_FULL_ACCESS_LABEL = "Full access to a com.fakhrulasa.accountathenticator account";
    ...
    public boolean addAccountExplicitly(Account account, String password, Bundle userdata) {
        ...
        if (bAdded) {
            ...
            Toast toast = Toast.makeText(_context,"Acc created", Toast.LENGTH_LONG);
            toast.show();
        } else {


            Toast toast = Toast.makeText(_context,"Acc not created", Toast.LENGTH_LONG);
            toast.show();
        }
    ...
    public boolean isValidUser(String userName) {
        ...
        if (account == null) {
            ...
            Toast toast = Toast.makeText(_context, "No acc", Toast.LENGTH_SHORT);
            toast.show();
        ...
        if (!account.name.equals(userName)) {
            ...
            Toast toast = Toast.makeText(_context, "No acc for user", Toast.LENGTH_SHORT);
            toast.show();

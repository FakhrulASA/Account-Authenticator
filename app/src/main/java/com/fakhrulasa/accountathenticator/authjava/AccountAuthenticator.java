...
public class  AccountAuthenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType, String authTokenType, String[] requiredFeatures, Bundle options) throws NetworkErrorException {
        ...
        intent.putExtra(com.fakhrulasa.accountathenticator.authjava.AccountHelper.ARG_ACCOUNT_TYPE, accountType);
        intent.putExtra(com.fakhrulasa.accountathenticator.authjava.AccountHelper.ARG_AUTH_TYPE, authTokenType);
        intent.putExtra(com.fakhrulasa.accountathenticator.authjava.AccountHelper.ARG_IS_ADDING_NEW_ACCOUNT, true);
    ...
    public Bundle confirmCredentials(AccountAuthenticatorResponse response, Account account, Bundle options) throws NetworkErrorException {
        ...
        if (options != null && options.containsKey(AccountManager.KEY_PASSWORD)) {
            ...
            accountPassword = com.fakhrulasa.accountathenticator.authjava.AccountHelper.getInstance(_context).getPassword(account);
        ...
        intent.putExtra(AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE, response);
        intent.putExtra(com.fakhrulasa.accountathenticator.authjava.AccountHelper.ARG_ACCOUNT_NAME, account.name);
        intent.putExtra(com.fakhrulasa.accountathenticator.authjava.AccountHelper.ARG_ACCOUNT_TYPE, account.type);
        intent.putExtra(com.fakhrulasa.accountathenticator.authjava.AccountHelper.ARG_CONFIRMCREDENTIALS, true);
